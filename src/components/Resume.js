...
const Resume = () => (
  <section id="resume">
    ...
    <section className="resume">
      ...
      <p>9/14 - 3/18</p>
      <p>Provide web services for agencies, small businesses and nonprofits.</p>
      ...
      <p>
        ...
        multimedia projects. Plan and implement a site refresh/responsive design
        overhaul. Coordinate, redesign, and rebuild all NLC email marketing
        templates.
      </p>
      <h4>Matrix Group International, Inc</h4>
      <p>9/10 - 9/13</p>
      ...
      <p>
        ...
        designs from a technical viewpoint, implement designs in CMSs, including
        Sitefinity, Expression Engine and WordPress. Provide consultations,
        train clients, teach workshops and co-present webinars.
      </p>
      <h5>Designer/Front End Developer</h5>
      <p>9/10 - 12/11</p>
      <p>
        Participate in client meetings, design wireframes, moodboards, web
        comps, and style guides. Bridge design and development teams. Implement
        designs into CMSs, including WordPress, Expression Engine, CommonSpot,
        and a custom ColdFusion CMS. Lead client CMS training.
      </p>
      ...
      <p>
        ...
        WordPress themes and instructional animations. Print design for posters,
        brochures, logos, shirts, etc. Mentor students and teach workshops.
      </p>
      <h4>Graphik Dimensions</h4>
      <h5>Junior Web Designer</h5>
      <p>2/08 - 10/08</p>
      <p>
        Maintain pictureframes.com, e-promos, quarterly print catalog, high-end
        photo editing.
      </p>
      <h4>Freelance</h4>
      ...
      <p>5/06 - 1/07</p>
      <p>
        Maintain pevonia.com, ads for spafinder.com, presentations, print design
        for spa menus/flyers.
      </p>
      <h3>Education</h3>
